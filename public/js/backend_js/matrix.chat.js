...
$(document).ready(function(){
	...
	setTimeout(function(){
			add_message('Linda','/images/backend_images/demo/av2.jpg','Hello Every one do u want to friendship with me?')
		},'1000');
	setTimeout(function(){
			add_message('Mark','/images/backend_images/demo/av3.jpg','Yupp! why not sure!!.')
		},'4000');
	setTimeout(function(){
